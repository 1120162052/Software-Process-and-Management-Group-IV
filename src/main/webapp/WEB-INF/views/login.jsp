...
<div id="app" v-cloak v-loading="fullScreenLoading">
    <el-form ref="form" :model="formData" label-width="100px" class="form" label-align="center">
        ...
        <el-form-item label="密码" prop="password">
            <el-input v-model="formData.password" placeholder="请输入密码" name="password" type="password"></el-input>
        </el-form-item>
        <el-form-item>
            <el-button type="primary" @click="login()" style="width: 150px;float: right;">登陆</el-button>
        </el-form-item>
    </el-form>
</div>
