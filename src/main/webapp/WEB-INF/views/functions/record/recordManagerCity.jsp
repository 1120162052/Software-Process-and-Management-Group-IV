...
<div id="app" v-cloak style="background: white;height: 100%;overflow: hidden;" v-loading="fullScreenLoading">
    ...
    <el-table :data="table.data" height="calc(100% - 116px)" v-loading="table.loading"
        ...
        <el-table-column label="备案状态" prop="recordStatus" width="200px"></el-table-column>
        <el-table-column label="报审状态" prop="recordStatus2"></el-table-column>
        <el-table-column label="操作" width="200" header-align="center" align="center">
            <template slot-scope="scope">
                <el-button type="primary" size="mini" style="position:relative;bottom: 1px;" @click="handleViewRecord(scope.row)">
                    <span>查看</span>
                </el-button>
